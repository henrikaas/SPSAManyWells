...
if __name__ == "__main__":
    ...
    # main_exp = "experiments scaling factor v2"
    ...
    #     plot_decision_vector(experiment_name=f"{main_exp}/{exp.name}")
        # plot_decision_vector_history(experiment_name=f"{main_exp}/{exp.name}", wells_to_plot=None, only_optimizing_iterations=True, runs=[1,2,3,4,5], type="scatter", save=False)
        # plot_step_size(experiment_name=f"{main_exp}/{exp.name}", n_runs=10, iteration=50, save=False)
