...
####################################################################
def read_dump(dataset_name='manywells-sol-1', data_path='../../data'):
    """
    Reads the data dump files, compiles them into a single DataFrame and stores it as a .csv file.
    Also compiles the configuration data into a separate DataFrame and stores it as a .csv file.
    """
...
if __name__ == '__main__':
    # experiment_name = "experiments rho/mixedprod_rho0.5_water15" # Change this as needed
    ...
    main_exp = "experiments relaxed cyclicSPSA/12wells" # Change this as needed
